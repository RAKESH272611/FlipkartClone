  ...
  return (
    <>
      <Typography>{product.title.longTitle}</Typography>
        ...
        8 Ratings & 1 Reviews
        <Box component="span"><img src={fassured} alt='fg' style={{width:77,marginLeft:20}}/></Box>
        </Typography>
        <Typography>
        ...
        <SmallText>
            ...
            <Typography><StyledBadge/>Buy 2 items save 5%;Buy 3 items save 10% T&C</Typography>
            <Typography><StyledBadge/>5% Cashback of Flipkart Axis Bank Card</Typography>
        ...
        <Table>
            <TableBody>
                ...
                <ColumnText>
                    <TableCell colSpan={2}>
                        <img src={adURL} alt='sp' style={{width:390}}/>
                    </TableCell>
                </ColumnText>
                <ColumnText>
